...
<?php
	...
	{
		var_dump(hash_substr("sha256", "ABCDE123456789VWXYZ", false, array(), 5, -5) === hash("sha256", "123456789"));
		var_dump(hash_substr("sha256", "ABCDE123456789VWXYZ", false, array(), -14, -5) === hash("sha256", "123456789"));
	}
	else
	{
